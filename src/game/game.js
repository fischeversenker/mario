...
/* global define */
define(['eventManager', 'renderer', 'world', 'entities/simpleShape', 'input', 'entities/playground', 'entities/staticShape', 'camera'], function(EventManager, Renderer, World, SimpleShape, Input, Playground, StaticShape, Camera){
...
//            World.addEntity(new CircleShape(50, 100, 6, 75, 25, "#9be000"));
    ...
    return {
        init: function () {
            ...
            World.init();
            World.setPlayground(new Playground(2000, 2000, "#8b8b8b"));

            Renderer.setWorld(World);

            Player = new SimpleShape(0, 0, 10, 75, 30, "#31d400");
